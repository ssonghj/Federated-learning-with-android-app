...
public class CompleteListView extends BaseAdapter {
    ...
    private ArrayList<flwr.android_client.ListData> listViewData = null;
    private int count = 0;

    private Context context;
    private List list;
    private HashMap map;
    public CompleteListView(Context context, ArrayList<flwr.android_client.ListData> listData, List str_list, HashMap completeTagMap)
    {
